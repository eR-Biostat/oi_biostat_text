...
the proportion of U.S. adults who live with one or more chronic conditions. Also, interpret the confidence interval in the context of the study.
}{}
...
\begin{center}
\includegraphics[width=0.6\textwidth]{ch_inference_foundations_oi_biostat/figures/eoce/age_at_first_marriage_intro/age_at_first_marriage_intro_hist.pdf}
\end{center}
...
\end{parts}
\begin{center}
\includegraphics[width=0.6\textwidth]{ch_inference_foundations_oi_biostat/figures/eoce/pennies_ages/pennies_ages_pop.pdf} \\
\includegraphics[width=0.325\textwidth]{ch_inference_foundations_oi_biostat/figures/eoce/pennies_ages/pennies_ages_sampling_n5.pdf} 
\includegraphics[width=0.325\textwidth]{ch_inference_foundations_oi_biostat/figures/eoce/pennies_ages/pennies_ages_sampling_n30.pdf} 
\includegraphics[width=0.325\textwidth]{ch_inference_foundations_oi_biostat/figures/eoce/pennies_ages/pennies_ages_sampling_n100.pdf} 
\end{center}
}{}
...
\begin{center}
\includegraphics[width=0.55\textwidth]{ch_inference_foundations_oi_biostat/figures/eoce/identify_dist_symm_pop/identify_dist_symm_pop.pdf} \\
\includegraphics[width=0.325\textwidth]{ch_inference_foundations_oi_biostat/figures/eoce/identify_dist_symm_pop/identify_dist_symm_sampling_n5.pdf}
\includegraphics[width=0.325\textwidth]{ch_inference_foundations_oi_biostat/figures/eoce/identify_dist_symm_pop/identify_dist_symm_samp.pdf}
\includegraphics[width=0.325\textwidth]{ch_inference_foundations_oi_biostat/figures/eoce/identify_dist_symm_pop/identify_dist_symm_sampling_n25.pdf}
\end{center}
}{}
...
\begin{center}
\includegraphics[width=0.55\textwidth]{ch_inference_foundations_oi_biostat/figures/eoce/identify_dist_ls_pop/identify_dist_ls_pop.pdf}
\end{center}
\begin{center}
\includegraphics[width=0.325\textwidth]{ch_inference_foundations_oi_biostat/figures/eoce/identify_dist_ls_pop/identify_dist_ls_sampling_n81.pdf}
\includegraphics[width=0.325\textwidth]{ch_inference_foundations_oi_biostat/figures/eoce/identify_dist_ls_pop/identify_dist_ls_samp.pdf}
\includegraphics[width=0.325\textwidth]{ch_inference_foundations_oi_biostat/figures/eoce/identify_dist_ls_pop/identify_dist_ls_sampling_n18.pdf}
\end{center}
}{}
...
\begin{center}
\includegraphics[width=0.5\textwidth]{ch_inference_foundations_oi_biostat/figures/eoce/songs_on_ipod/songs_on_ipod_pop_hist.pdf}
\end{center}
\begin{parts}
