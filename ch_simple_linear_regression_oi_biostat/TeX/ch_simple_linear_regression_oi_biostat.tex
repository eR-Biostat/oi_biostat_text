...
A total of 4,095 individuals participated in the study; RFFT scores for a random sample of 500 individuals are shown in Figure~\ref{statinsAgeRFFT}, plotted against age at enrollment, measured in years. The variables \var{Age} and \var{RFFT} are negatively associated; older participants tend to have lower cognitive function. There is an approximately linear trend observable in the data, which suggests that adding a line could be useful for summarizing the relationship between the two variables.
