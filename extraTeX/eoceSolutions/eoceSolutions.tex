...
\eocesol{(a)~$H_0$: The restaurant is meeting regulations. $H_A$: The restaurant is not meeting regulations (i.e., sanitation practices are poorer than required). \\
	(b)~A Type I error is concluding the restaurant is meeting regulations when they are not. \\
	(c)~A Type II error is concluding the restaurant is not meeting regulations when they are. \\
	(d)~A Type II error is more problematic for the restaurant, since they will lose the license to serve food even when they are meeting regulations. \\
	(e)~A Type I error is more problematic for diners, because they will be in danger of being served food that is not prepared in sanitary conditions. \\
	(f)~As a diner, I would prefer that the inspector requires strong evidence of health concerns rather than very strong before revoking a license, because a Type I error is more dangerous to public health. 
	}
