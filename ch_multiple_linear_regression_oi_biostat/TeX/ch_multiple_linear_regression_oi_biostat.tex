...
The process behind model selection will be illustrated with a case study in which a regression model is built for the association between the abundance of forest birds in a habitat patch and features of a patch.
